public class Lesson {
    ...
    public static void task10() {
        ...
        System.out.println("___________________________________________________________________");
        System.out.println(" Задача 3. Определение високосного года");//Определение високосного года.;
        int year=1987;
        float checkingYear=year/4f;
        float checkingYear1=1;// Необходимо придумать олгоритм для учета checkingYear1=year/400 if (checkingYear1%1!=0)
        System.out.println(" Промежуточная переменная " + checkingYear + " при высокосном годе она кратна 4.");// В дата високосного года делится без остатка на "4";
        System.out.println(" Промежуточная переменная " + checkingYear1 + " год кратный 100 не является високосным кроме 400.");// В дата високосного года делится без остатка на "100";
        if (checkingYear%1==0&&checkingYear1==1) {
